...
learn_description2: function(){
  ...
  var inst_order =  _.shuffle([0, 1, 2])
  $("img.Pic1").attr("src", "images/face" + experiment.face_order[inst_order[0]] + ".png");
  $("img.Pic2").attr("src", "images/face" + experiment.face_order[inst_order[1]] + ".png");
  $("img.Pic3").attr("src", "images/face" + experiment.face_order[inst_order[2]] + ".png");
  ...
  temp = random(1,6);    
  all_ad_img.src = "images/allad" + temp + ".png";
  $("img.all_advisors").attr("src", all_ad_img.src);
...
recordanswer:function(){
  ...
  if (faceacc[1] == undefined || faceacc[2] == undefined || faceacc[3] == undefined || faceacc[4] == undefined || faceacc[5] == undefined || faceacc[6] == undefined){
    ...
    experiment.demographics(self,faceacc)
  }  
},
    
demographics: function(self,faceacc) {
  analyst = [];
  foil = [];
    
  bonus = experiment.tally * 5 + 180;
  if (bonus > 350){bonus = 350}
  if (bonus < 180){bonus = 180 + _.sample([5,10,15,20])}
